        ...
        {/* <div className="divide-y divide-border/40 border-y border-border/40">
          {steps.map((s, i) => (
            <motion.div
              ...
              className="group grid grid-cols-12 gap-6 py-8 md:py-10 items-baseline cursor-default"
            >
              <span className="col-span-2 md:col-span-1 text-sm md:text-base text-muted-foreground tabular-nums">
                {s.n}
              </span>
              <h3 className="col-span-10 md:col-span-4 text-2xl md:text-4xl font-semibold tracking-tight transition-transform duration-500 group-hover:translate-x-2">
                {s.title}
              </h3>
              <p className="col-span-12 md:col-span-7 text-base md:text-lg text-muted-foreground leading-relaxed">
                {s.desc}
              </p>
            </motion.div>
          ))}
