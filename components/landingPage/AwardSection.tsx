...
const CARDS: CardCfg[] = [
  { src: card2.src, x: 18, y: 32, rot: -10, scale: 0.95, fromX: -300, fromY: -200, fromRot: -45 },
  { src: card1.src, x: 72, y: 28, rot: 8,   scale: 1.05, fromX:  300, fromY: -250, fromRot:  40 },
  { src: card3.src, x: 42, y: 50, rot: -5,  scale: 1.15, fromX:    0, fromY:  300, fromRot: -25 },
  { src: card4.src, x: 14, y: 62, rot: 10,  scale: 0.9,  fromX: -350, fromY:  250, fromRot:  35 },
  { src: card5.src, x: 80, y: 60, rot: -8,  scale: 0.95, fromX:  350, fromY:  200, fromRot: -30 },
  { src: card6.src, x: 50, y: 68, rot: 6,   scale: 1.0,  fromX:    0, fromY:  350, fromRot:  20 },
];
